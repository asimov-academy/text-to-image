...
# FLUX1 INFERENCE
flux1_inference = Flux1Inference("/mnt/ssd2/models/text-to-image/black-forest-labs-FLUX.1-dev", gpu_index=1, steps=10)
...
stable_diffusion_inference = StableDiffusionInference("/mnt/ssd2/models/text-to-image/stable-diffusion-3", gpu_index=1)
